...
brew 'jira-cli'   # Jira issue tracker CLI
...
cask 'eagle'                    # Design asset manager
...
cask 'magicquit'      # Auto-close idle apps
cask 'obscura-vpn'    # Privacy VPN
cask 'rouvy'          # Indoor cycling
...
# Mac App Store
mas 'Bear', id: 1091189122          # Notes app
mas 'Boop', id: 1518425043          # Clipboard manager
mas 'Dato', id: 1470584107          # Menubar calendar
mas 'Googly Eyes', id: 6743048714   # Fun menubar eyes
mas 'HazeOver', id: 430798174       # Focus tool
mas 'Pandan', id: 1569600264        # Break reminder
